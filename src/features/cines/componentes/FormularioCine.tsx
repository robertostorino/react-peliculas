...
import Mapa from "../../../componentes/Mapa/Mapas";
import type Coordenada from "../../../componentes/Mapa/Coordenada.model";

export default function ForumarioCine(props: FormularioCineProps){
    ...
    const {
        ...
        function transformarCoordenadas () : Coordenada[] | undefined {
            ...
            // Si no se ejecuta, significa que modelo es undefined
            return undefined;
        }
