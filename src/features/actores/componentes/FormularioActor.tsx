...
export default function FormularioActor(props: FormularioActorProps){
    ...
    const imagenActualURL: string | undefined = props.modelo ? props.modelo.foto as string : undefined;  // Si la foto está presente indica que estamos en modo edición.

    return (
        <form onSubmit={handleSubmit(props.onSubmit)}>
            <div className="form-group">
                <label htmlFor="nombre">Nombre</label>
                <input type="text" id="nombre" autoComplete="off" className="form-control" 
                {...register('nombre')} />
