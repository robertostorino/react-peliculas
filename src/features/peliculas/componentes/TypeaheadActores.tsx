...
export default function TypeaheadActores(props: TypeaheadActoresProps){
    ...
    const actores: ActorPelicula[] = [
        ...
        },
        {
            ...
            nombre: "Marisa Tomei",
            personaje: "",
            foto: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Marisa_Tomei_by_David_Shankbone.jpg/960px-Marisa_Tomei_by_David_Shankbone.jpg"
        },
        {
            id: 3,
            nombre: "Tom Hanks",
            personaje: "",
            foto: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/39/TomHanksPrincEdw031223_%2811_of_41%29_%28cropped%29.jpg/960px-TomHanksPrincEdw031223_%2811_of_41%29_%28cropped%29.jpg"
        }
    ];
    ...
    // Cuando el elemento arrastrado se está moviendo sobre otro elemento
    const manejarDragOver = (actor: ActorPelicula) => {
        ...
        const actores = [...props.actores]; // Clona el arreglo de actores
        const indiceDesde = actores.findIndex(x => x.id === elementoArrastrado.id); // Índice desde donde el elemento ha sido arrastrado
        const indiceHasta = actores.findIndex(x => x.id === actor.id); // Índice del actor sobre el cuál yo estoy arrastrando al actor original

        // Intercambio los índices
        if (indiceDesde !== -1 && indiceHasta !== -1){
            // Utilizo una destructuración
            [actores[indiceDesde], actores[indiceHasta]] = [actores[indiceHasta], actores[indiceDesde]]; // Intercambia los elementos del arreglo
            props.onAdd(actores);
        }
        ...
        <>
            ...
            <Typeahead 
                ...
                renderMenuItemChildren={(opcion: Option) => {
                    ...
                    return (
                        <>
                            <img alt="imagen acton" src={actor.foto}
                            style={{
                                height: '64px',
                                width: '64px',
                                marginRight: '10px'
